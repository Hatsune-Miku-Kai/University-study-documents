...
int SMS_STS::WritePosEx(u8 ID, u16 Position, u16 Speed, u8 ACC, u16 Torque)
{
	if(Position<0){
		Position = -Position;
		Position |= (1<<15);
...
void SMS_STS::SyncWritePosEx(u8 ID[], u8 IDN, s16 Position[], u16 Speed[], u8 ACC[], u16 Torque[])
{
    u8 offbuf[7*IDN];
	u16 torque[IDN] = {0};
    for(u8 i = 0; i<IDN; i++){
