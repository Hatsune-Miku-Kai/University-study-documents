...
{
    public partial class 注册窗体 : Form
    {
        public 注册窗体()
        {
            InitializeComponent();
        ...
        private void 注册窗体_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string queryStr = "select * from yhb where yhm='" + textBox1.Text + "'";
                //5.2执行SQL语句
                MySqlDataAdapter myDap = new MySqlDataAdapter(queryStr, Form1.myCon);
                //5.3将查询结果存储进行表格变量dt
                ...
                else
                {
                    ...
                    string insertStr = "insert into yhb values('" + textBox1.Text.Trim() + "','" + textBox2.Text.Trim() + "','" + textBox4.Text.Trim() + "','" + comboBox1.Text.Trim() + "','" + textBox5.Text.Trim() + "','" + textBox6.Text.Trim() + "')"; //实现将用户填写的信息写入数据库的SQL语句
