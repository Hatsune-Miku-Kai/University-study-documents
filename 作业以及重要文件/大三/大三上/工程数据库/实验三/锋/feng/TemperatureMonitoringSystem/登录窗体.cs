    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string conStr = "data source=localhost;database =wdjc;user id=root;password=Guo031028;charset=utf8";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("用户名不存在", "注意", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);//提示信息的对话框
                    textBox1.Focus();//焦点落在用户名文本框
                    return; //结束函数的运行
                }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        系统主界面窗体 f = new 系统主界面窗体();//创建“系统主界面窗体”
                        f.Show();//打开“系统主界面窗体”      
                        this.Hide();//隐藏“登录窗体”
                    }
                }
